...
namespace Server.Spells
{
	...
	public class SpellHelper
	{
		...
		// Hey Kent recalling in and out of locations here
		private static bool[,] m_Rules = new bool[,]
			{
					/*T2A(Fel),	Wind(Fel),	Dungeons(Fel),	SafeZone */
/* Recall From */	{ true,		false,		true,			true },
/* Recall To */		{ true,		false,		true,			false },
/* Gate From */		{ true,		false,		true,			false },
/* Gate To */		{ true,		false,		true,			false },
/* Mark In */		{ true,		false,		true,			false },
