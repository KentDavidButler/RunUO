...
{
	public class MageAggresiveAI : BaseAI
	{
		private DateTime m_NextCastTime;
		private DateTime m_NextHealTime;

		public MageAggresiveAI( BaseCreature m )
			: base( m )
		{
		}
		...
		private const double HealChance = 0.25; // 10% chance to heal at gm magery
		private const double TeleportChance = 0.15; // 5% chance to teleport at gm magery
		private const double DispelChance = 0.90; // 75% chance to dispel at gm magery
		...
		private Spell CheckCastHealingSpell()
		{
			...
			else if( m_Mobile.Hits < Math.Ceiling(m_Mobile.HitsMax/1.2))
			{
			...
			if( m_Mobile.Int >= 500 )
				...
				delay = Utility.RandomMinMax(10, 13);
        ...
        public virtual Spell GetRandomDamageSpellMage()
		{
			...
			switch( Utility.Random( maxCircle * 2 ) )
			{
				...
				case 2: return new HarmSpell(m_Mobile, null);
				case 3: return new FireballSpell(m_Mobile, null);
				case 4: return new ManaDrainSpell(m_Mobile, null);
				case 5: return new LightningSpell(m_Mobile, null);
				case 6: return new FlameStrikeSpell(m_Mobile, null);
				case 7: return new MindBlastSpell(m_Mobile, null);
				case 8: return new EnergyBoltSpell(m_Mobile, null);
				case 9: return new ExplosionSpell(m_Mobile, null);
				case 10: return new EnergyBoltSpell( m_Mobile, null );
				case 11: return new ExplosionSpell( m_Mobile, null );
				case 12: return new EnergyBoltSpell(m_Mobile, null);
