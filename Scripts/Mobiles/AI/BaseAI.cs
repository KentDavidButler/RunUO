    ...
    public abstract class BaseAI
    {
        ...
        public virtual bool DoOrderGuard()
        {
            ...
            if (aggressors.Count > 0)
            {
                ...
                if (combatant != null)
                    m_Mobile.DebugSay(
                        "Crap, my master has been attacked! I will attack one of those bastards!"
                    );
            }
        ...
        )
        {
            ...
            if (map != null)
            {
                ...
                m_Mobile.DebugSay("Map is not Null...");
                foreach (Mobile m in eable)
                {
                    if (m.Deleted || m.Blessed)
                    {
                        m_Mobile.DebugSay("Deleted or blessed...");
                        continue;
                    }
                    ...
                    if (m == m_Mobile)
                    {
                        m_Mobile.DebugSay("Don't Target self");
                        continue;
                    }
                    ...
                    {
                        m_Mobile.DebugSay("Targets invalid");
                        continue;
                    }
                    ...
                    {
                        m_Mobile.DebugSay("Don't attack staff members");
                        continue;
                    }
                    ...
                    {
                        m_Mobile.DebugSay("Don't attack things we can't see");
                        continue;
                    }

                    if (m_Mobile.Summoned && m_Mobile.SummonMaster != null)
                    {
                        m_Mobile.DebugSay("Summoned Section");
                        ...
                        if (
                            !Server.Spells.SpellHelper.ValidIndirectTarget(m_Mobile.SummonMaster, m)
                        )
                            continue;
                    }
                    ...
                    {
                        m_Mobile.DebugSay("Only Caction friends");
                        continue;
                    }

                    if (acqType == FightMode.Aggressor || acqType == FightMode.Evil)
                    {
                        m_Mobile.DebugSay("Getting acquire Type aggressor or evil");
                        bool bValid = IsHostile(m);

                        if (acqType == FightMode.Evil && !bValid)
                        {
                            m_Mobile.DebugSay("Type Evil and Not valid");
                            if (
                                m is BaseCreature
                        ...
                        if (!bValid)
                            m_Mobile.DebugSay("Getting acquire Type aggressor or evil: Not valid");
                        continue;
                    }
                    else
                    {
                        m_Mobile.DebugSay("Faction Enemies");
                        // Same goes for faction enemies.
                        if (bFacFoe && !m_Mobile.IsEnemy(m))
                        {
                            m_Mobile.DebugSay("FacFoe not enemy");
                            continue;
                        }
                        ...
                        {
                            m_Mobile.DebugSay("enemy Factioned mobile");
                            continue;
                        }
                    }
                    ...
                    {
                        m_Mobile.DebugSay("No Idea");
                        newFocusMob = m;
                        val = theirVal;
                    }
                }
                m_Mobile.DebugSay("Close to the end");
            ...
            m_Mobile.DebugSay("We Go nothing");
            return m_Mobile.FocusMob != null;
        }
