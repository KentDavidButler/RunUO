		...
		private static SpeedInfo[] m_Speeds = new SpeedInfo[]
			{
				...
				{
					typeof( Alligator ),		typeof( AncientLich ),		typeof( AgapiteElemental ),
					typeof( Bird ),
					typeof( BlackBear ),
					...
					typeof( Cat ),							
					typeof( Chicken ),			typeof( CopperElemental ),
					typeof( Cougar ),			typeof( Cow ),				typeof( Cyclops ),			
					typeof( Daemon ),			typeof( DarkWisp ),			typeof( DeepSeaSerpent ),
					...
					typeof( FireElemental ),	typeof( FireGargoyle ),	
					...
					typeof( RidableLlama ),
					typeof( Scorpion ),			typeof( SeaSerpent ),		typeof( ShadowWisp ),
					typeof( Shade ),			typeof( Sheep ),
					typeof( SkeletalMage ),
					typeof( HellCat ),			typeof( Snake ),			typeof( ShadowIronElemental ),
