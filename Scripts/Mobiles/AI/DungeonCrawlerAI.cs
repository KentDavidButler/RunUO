...
// Review Rummage in BaseCreature Class for hints how to loot
    ...
    public class MagePlayerAI : MageAI
    {
        ...
        public override bool DoActionWander()
        {
            ...
            if (
                ...
                && manaPercent < 0.50
                && !m_Mobile.Poisoned
                && m_Mobile.Skills.Meditation.Value > 60.0
            )
            {
                // Restore Mana
        ...
        public override bool DoActionCombat()
        {
            ...
            if ((combatant != null || !combatant.Deleted || combatant.Alive) && combatant.Hits > 80)
            {
                ...
                !combatant.Poisoned
                && m_NextPoisonTimer < DateTime.Now
                && m_NextCastTime < DateTime.Now
            )
            {
                m_NextCastTime = DateTime.Now + TimeSpan.FromSeconds(3.0);
        ...
        // Backoff will keep the NPC engauged in the fight, while allowing them to Rest or heal befor re-enguaging
        {
            ...
            else
            {
                ...
                if (
                    m_RunAwayTimer > DateTime.Now
                    || ((int)m_Mobile.GetDistanceToSqrt(m_RunFrom) > 3)
                )
                {
        ...
        {
            if (
                m_Mobile.FindItemOnLayer(Layer.OneHanded) != null
