...
namespace Server.Mobiles
{
	public class SBMage : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			...
			{
				// this is what you can buy from a vendor *HeyKent
				...
				Add( new GenericBuyInfo( "Black Pearl", typeof( BlackPearl ), 5, 50, 0xF7A, 0 ) );
				Add( new GenericBuyInfo( "Blood Moss", typeof( Bloodmoss ), 5, 50, 0xF7B, 0 ) );
				Add( new GenericBuyInfo( "Garlic", typeof( Garlic ), 3, 50, 0xF84, 0 ) );
				Add( new GenericBuyInfo( "Ginseng", typeof( Ginseng ), 3, 50, 0xF85, 0 ) );
				Add( new GenericBuyInfo( "Mandrake Root", typeof( MandrakeRoot ), 3, 50, 0xF86, 0 ) );
				Add( new GenericBuyInfo( "Nightshade", typeof( Nightshade ), 3, 50, 0xF88, 0 ) );
				Add( new GenericBuyInfo( "Spider's Silk", typeof( SpidersSilk ), 3, 50, 0xF8D, 0 ) );
				Add( new GenericBuyInfo( "Sulfurous Ash", typeof( SulfurousAsh ), 3, 50, 0xF8C, 0 ) );
	    ...
	    public class InternalSellInfo : GenericSellInfo
	    {
	        ...
	        {
				//this is what you can sell to a vendor
