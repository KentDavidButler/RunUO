...
namespace Server.Engines.BulkOrders
{
	...
	public sealed class SmithRewardCalculator : RewardCalculator
	{
		...
		private static readonly ConstructCallback DaemonArms = new ConstructCallback( CreateDaemonArms );
		private static readonly ConstructCallback DaemonChest = new ConstructCallback(CreateDaemonChest);
		private static readonly ConstructCallback DaemonGloves = new ConstructCallback(CreateDaemonGloves);
		private static readonly ConstructCallback DaemonHelm = new ConstructCallback(CreateDaemonHelm);
		private static readonly ConstructCallback DaemonLegs = new ConstructCallback(CreateDaemonLegs);
		...
		private static Item CreateDaemonArms(int type)
		{
			return new DaemonArms();
		}

		private static Item CreateDaemonChest(int type)
		{
			return new DaemonChest();
		}

		private static Item CreateDaemonGloves(int type)
		{
			return new DaemonGloves();
		}

		private static Item CreateDaemonHelm(int type)
		{
			return new DaemonHelm();
		}

		private static Item CreateDaemonLegs(int type)
		{
			return new DaemonLegs();
		}
			...
			Groups = new RewardGroup[]
				{
					...
					new RewardGroup(  500, new RewardItem( 1, DaemonArms, 1 ) ),
					new RewardGroup(  550, new RewardItem( 3, DaemonGloves, 1 ), new RewardItem( 2, DaemonHelm, 2 ) ),
					new RewardGroup(  600, new RewardItem( 1, DaemonLegs, 2 ) ),
					new RewardGroup(  625, new RewardItem( 3, DaemonChest, 2 ), new RewardItem( 6, PowerScroll, 5 ), new RewardItem( 1, ColoredAnvil ) ),
					new RewardGroup(  650, new RewardItem( 1, MiningGloves, 3 ) ),
					new RewardGroup(  675, new RewardItem( 1, ColoredAnvil ), new RewardItem( 6, PowerScroll, 10 ), new RewardItem( 3, DaemonArms, 3 ) ),
					new RewardGroup(  700, new RewardItem( 1, DaemonGloves, 4 ) ),
					...
					new RewardGroup(  950, new RewardItem( 1, DaemonHelm, 5 ) ),
					new RewardGroup( 1000, new RewardItem( 1, AncientHammer, 30 ) ),
					new RewardGroup( 1050, new RewardItem( 1, ColoredAnvil, 6 ) ),
					new RewardGroup( 1100, new RewardItem( 1, AncientHammer, 60 ) ),
					new RewardGroup( 1150, new RewardItem( 1, DaemonLegs, 7 ) ),
					new RewardGroup( 1200, new RewardItem( 1, DaemonChest, 8 ) )
				};
		}
	}
	...
	public sealed class TailorRewardCalculator : RewardCalculator
	{
		...
		private static readonly ConstructCallback RangerArms = new ConstructCallback(CreateRangerArms);
		private static readonly ConstructCallback RangerChest = new ConstructCallback(CreateRangerChest);
		private static readonly ConstructCallback RangerGloves = new ConstructCallback(CreateRangerGloves);
		private static readonly ConstructCallback RangerGorget = new ConstructCallback(CreateRangerGorget);
		private static readonly ConstructCallback RangerLegs = new ConstructCallback(CreateRangerLegs);
		...
		private static Item CreateRangerArms(int type)
		{
			return new RangerArms();
		}

		private static Item CreateRangerChest(int type)
		{
			return new RangerChest();
		}

		private static Item CreateRangerGloves(int type)
		{
			return new RangerGloves();
		}

		private static Item CreateRangerGorget(int type)
		{
			return new RangerGorget();
		}

		private static Item CreateRangerLegs(int type)
		{
		...
		public TailorRewardCalculator()
		{
			Groups = new RewardGroup[]
			{
				...
				new RewardGroup( 300, new RewardItem( 1, RangerGloves ) ),
				new RewardGroup( 350, new RewardItem( 1, RangerGorget ) ),
				...
				new RewardGroup( 575, new RewardItem( 1, RangerArms ), new RewardItem( 1, RangerLegs ) ),
				new RewardGroup( 600, new RewardItem( 1, RangerChest ) ),
				new RewardGroup( 650, new RewardItem( 1, PowerScroll, 20 ) ),
				new RewardGroup( 700, new RewardItem( 1, ClothingBlessDeed, 3 ) )
			};
		}
	}
}